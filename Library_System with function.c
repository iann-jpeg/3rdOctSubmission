...
int DaysOverdue(int returnDate, int dueDate)
{
	return returnDate - dueDate;
}
int FineAmount(int daysOverdue, int fineRate)
{
...
int main() {
    ...
    if (returnDate > dueDate) {
        ...
        daysOverdue = DaysOverdue (returnDate,dueDate);
    ...
    fineAmount =FineAmount(daysOverdue,fineRate);
